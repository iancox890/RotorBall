...
namespace PsychedelicGames.RotorBall.Objectives
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "Objective(Number)(BonusBricksHit).asset", menuName = "Psychedelic Games/Objectives/Bonus Bricks Hit")]
    public class BonusBricksHit : Objective
    {
        ...
        {
            if (!report.Retried && report.MaxBonusBrickHits >= hits) { return true; }
